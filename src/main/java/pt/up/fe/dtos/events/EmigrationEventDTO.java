...
public class EmigrationEventDTO {
    private String typeOfEmigration;
    private Place place;
    private IDate date;
    private String pushFactor;
    private String pullFactor;
    ...
    public String getTypeOfEmigration() {
        return typeOfEmigration;
    }

    public void setTypeOfEmigration(String typeOfEmigration) {
        this.typeOfEmigration = typeOfEmigration;
    }
    ...
    public void setPushFactor(String pushFactor) {
        this.pushFactor = pushFactor;
    }

    public String getPullFactor() {
        return pullFactor;
    }

    public void setPullFactor(String pullFactor) {
