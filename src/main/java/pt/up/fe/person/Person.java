...
public class Person extends BaseClass {
  ...
  public PersonIteratorInterface<ImmutablePair<Integer, Person>> createIteratorWithDepthLimit(
      int limit) {
  ...
  public List<Event> getMarriages() {
    return this.events.stream()
        .filter((event) -> event.getClass() == Marriage.class)
  ...
  public List<Person> getPartners() {
    ...
    marriages.forEach(
        (marriage) -> {
          ...
          partners.add(currentMarriage.getPartner(this));
        });
    return partners;
  }
